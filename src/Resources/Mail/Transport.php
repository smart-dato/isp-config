...
final class Transport extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_transport_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_transport_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_transport_delete', $id);
    }
}
