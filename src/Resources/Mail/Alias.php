...
final class Alias extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_alias_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_alias_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_alias_delete', $id);
    }
}
