...
final class AliasDomain extends Resource
{
    ...
    {
        /** @var int */
        return $this->call('mail_aliasdomain_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_aliasdomain_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_aliasdomain_delete', $id);
    }
}
