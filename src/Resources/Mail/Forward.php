...
final class Forward extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_forward_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_forward_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_forward_delete', $id);
    }
}
