...
final class RelayRecipient extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_relay_recipient_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_relay_recipient_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_relay_recipient_delete', $id);
    }
}
