...
final class SpamfilterWhitelist extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_whitelist_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_whitelist_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_spamfilter_whitelist_delete', $id);
    }
}
