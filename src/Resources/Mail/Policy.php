...
final class Policy extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_policy_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_policy_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_policy_delete', $id);
    }
}
