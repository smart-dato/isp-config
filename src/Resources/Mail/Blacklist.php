...
final class Blacklist extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_blacklist_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_blacklist_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_blacklist_delete', $id);
    }
}
