...
final class SpamfilterUser extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_user_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_user_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_spamfilter_user_delete', $id);
    }
}
