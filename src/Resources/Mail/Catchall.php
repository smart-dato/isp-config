...
final class Catchall extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_catchall_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_catchall_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_catchall_delete', $id);
    }
}
