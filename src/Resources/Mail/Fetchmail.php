...
final class Fetchmail extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_fetchmail_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_fetchmail_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_fetchmail_delete', $id);
    }
}
