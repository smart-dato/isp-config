...
final class Filter extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_filter_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_filter_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_filter_delete', $id);
    }
}
