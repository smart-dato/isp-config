...
final class SpamfilterBlacklist extends Resource
{
    /**
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_blacklist_add', $clientId, $params);
    }
    ...
    {
        /** @var int */
        return $this->call('mail_spamfilter_blacklist_update', $clientId, $id, $params);
    }

    public function delete(int $id): int
    {
        /** @var int */
        return $this->call('mail_spamfilter_blacklist_delete', $id);
    }
}
